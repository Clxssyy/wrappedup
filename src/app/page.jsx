...
export default function Home() {
  ...
  return (
    <main className='grow text-white flex flex-col justify-center'>
      <div className='flex justify-center p-2 gap-2 items-center'>
        <p className='font-bold'>Range: </p>
        <select
          name='time_range_options'
          id='time_range'
          className='bg-zinc-800 rounded-lg px-2 py-1 hover:border-green-400 active:border-green-400 border-2 border-transparent'
          onChange={(e) => {
          ...
          ? topSongs.map((song) => (
              <div
                ...
                <div className='w-full truncate'>
                  <p className='text-lg italic'>{song.name}</p>
